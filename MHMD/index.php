...
mkdir('data/txt');
mkdir('data/api');
$API_KEY= '7579529651:AAFlovN2LtrzrWBPARfpOftUsqO_ZJYDy1I';
...
$chall = "nom12300";
$useradmin = "@I_D_PP";
$sim =--1002332311520; #القناة الرسمية
$PAY =--1002417282864; #الارقام المكتملة
$ess =---1002354966306; #عمليات شراء الارقام
$eer =--1002376125620; #اشعارات الايميلات وتحويل الروبل
if($chat_id==7107831441){
$sudo=$chat_id;
}elseif($chat_id==7107831441){
$sudo=$chat_id;
}else{
$sudo==7107831441;
}
